...
Core/BSP/M/%.o Core/BSP/M/%.su Core/BSP/M/%.cyclo: ../Core/BSP/M/%.c Core/BSP/M/subdir.mk
...
clean: clean-Core-2f-BSP-2f-M

clean-Core-2f-BSP-2f-M:
	-$(RM) ./Core/BSP/M/motor.cyclo ./Core/BSP/M/motor.d ./Core/BSP/M/motor.o ./Core/BSP/M/motor.su

.PHONY: clean-Core-2f-BSP-2f-M
